...
// const resend = new Resend("re_VBNii47N_DUtdarc9Zxjfi4kxuHwjLqbN");
...
//             subject = `Welcome to Buying sense Price Tracking for ${shortenedTitle}`;
//             body = `
//             <div>
//               <h2>Welcome to BuyingSense 🚀</h2>
